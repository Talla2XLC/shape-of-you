...
assert_contains "$IDENTITY_COMPOSE" 'init: true'
...
assert_contains "$DEPLOY_WORKFLOW" 'https://chatgpt.com/connector_platform_oauth_redirect'
...
assert_contains "$COMPOSE" 'init: true'
