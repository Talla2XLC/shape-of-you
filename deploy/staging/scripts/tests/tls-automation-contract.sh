...
assert_contains "$DEPLOY" '/var/www/certbot/.well-known/acme-challenge/$challenge_probe'
...
assert_contains "$NGINX" 'proxy_pass http://api_backend/.well-known/oauth-protected-resource;'
