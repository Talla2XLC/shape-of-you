...
const trainingStore: TrainingStore = {
  ...
  readActivityRecordingMode: unreachable,
...
const intakeStore: IntakeStore = {
  ...
  clarify: unreachable,
  decide: unreachable,
  loadParseRequest: unreachable,
  loadClarificationRequest: unreachable,
  claimNextJob: unreachable,
  completeParse: unreachable,
  completeClarification: unreachable,
  routeWeight: unreachable,
  failJob: unreachable
};
