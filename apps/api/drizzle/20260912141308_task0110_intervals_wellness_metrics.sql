...
CREATE TYPE "public"."recovery_metric" AS ENUM('hrv_rmssd', 'resting_heart_rate', 'night_heart_rate', 'oxygen_saturation', 'minimum_oxygen_saturation', 'temperature_deviation', 'respiration_rate', 'body_battery', 'body_battery_min', 'body_battery_max', 'sleep_score');--> statement-breakpoint
